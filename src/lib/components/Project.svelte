...
<article class="relative flex flex-col overflow-hidden rounded bg-slate-800 p-2 md:p-4">
    ...
    <nav class="flex">
        <a href={project.repo} target="_blank" rel="noopener noreferrer"><img class="size-7 m-1 mt-2 mr-3" src="icons/github.svg" alt=""></a>
        {#if project.site}
            <a href={project.site} target="_blank" rel="noopener noreferrer"><img class="size-7 m-1 mt-2" src="icons/site.svg" alt="Site"></a>
        {/if}
    </nav>
</article>
